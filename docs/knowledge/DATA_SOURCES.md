...
- Diagnóstico seguro Phase1-020: conserva la clasificación sanitaria de fallos, incluido `DATAVERSE_INVALID_FIELD_OR_FILTER`, sin exponer detalles técnicos en el contrato HTTP. Los diagnósticos temporales Product Phase1-046/048/050/052 quedaron retirados por Phase1-055 junto con sus probes, consultas `EntityDefinitions`/`Attributes`, hooks, guards one-shot y eventos temporales. Los diagnósticos temporales Customer Phase1-022/024 continúan fuera del runtime.
