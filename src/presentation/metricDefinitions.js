...
export const METRIC_DEFINITIONS = Object.freeze([
  ...
  defineMetric('eolDefined', 'SKU con EOL definido', 'SKU cuyo estado de Product Master es EOL, sea futuro, vencido o sin fecha válida.', 'Conteo de registros con Estado = EOL.', 'SKU', 'Product Master', 'No equivale exclusivamente a descontinuados vencidos.'),
  ...
  defineMetric('eolBucket', 'Bucket EOL', 'Urgencia temporal respecto a la fecha EOL.', 'Vencido: fecha pasada/actual; Crítico: 1–27 días; Próximo: 28–83; Planificado: 84+.', 'Clasificación', 'EOL Engine + parámetros institucionales', 'Prioriza liquidación o gestión preventiva.'),
...
export const DEFINITION_GROUPS = Object.freeze({
  ...
  eol: Object.freeze(['eolDefined', 'eolExpired', 'eolBucket', 'eolRecommendation', 'inventoryValue']),
