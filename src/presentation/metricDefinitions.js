...
export const METRIC_DEFINITIONS = Object.freeze([
  ...
  defineMetric('eolDefined', 'SKU EOL', 'SKU clasificado como EOL en Product Master.', 'Conteo de registros con Estado = EOL en el universo analizado.', 'SKU', 'Product Master', 'Universo total EOL; puede incluir SKU sin Fecha EOL válida. El KPI y el detalle usan el mismo universo, unidades y valorización.'),
...
export const DEFINITION_GROUPS = Object.freeze({
  ...
  eol: Object.freeze(['eolDefined', 'eolDate', 'eolDays', 'eolBucket', 'eolRecommendation', 'rotationPercentage', 'inventoryValue']),
